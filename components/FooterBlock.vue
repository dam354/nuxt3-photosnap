<template>
  <footer class="grid grid-cols-1 bg-pure-black px-8 py-14 md:grid-cols-2">
    <div class="md:flex md:flex-col md:items-start md:justify-between lg:flex-row lg:justify-start">
      <div class="lg:flex lg:h-full lg:flex-col lg:justify-between">
        <section class="mx-auto mb-8 lg:mr-24 lg:mb-0">
          <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto md:ml-0" width="170" height="16">
            <defs>
        ...
        <section class="footer-social mx-auto mb-12 flex w-full max-w-[150px] flex-row justify-between md:ml-0 lg:mb-0">
          <a class="group" href="/"> <img class="brightness-500 transition-all duration-300 group-hover:brightness-100" src="/images/shared/desktop/facebook.svg" alt="" /></a>
          <a class="group" href="/"> <img class="brightness-500 transition-all duration-300 group-hover:brightness-100" src="/images/shared/desktop/youtube.svg" alt="" /></a>
          <a class="group" href="/"> <img class="brightness-500 transition-all duration-300 group-hover:brightness-100" src="/images/shared/desktop/twitter.svg" alt="" /></a>
          <a class="group" href="/"> <img class="brightness-500 transition-all duration-300 group-hover:brightness-100" src="/images/shared/desktop/pinterest.svg" alt="" /></a>
          <a class="group" href="/"> <img class="brightness-500 transition-all duration-300 group-hover:brightness-100" src="/images/shared/desktop/instagram.svg" alt="" /></a>
        </section>
      </div>
      <nav>
        <ul class="mb-[120px] text-center text-pure-white md:mb-0 lg:text-left">
          <li class="h4 md:mr-2 md:inline lg:block"><NuxtLink to="/"> HOME</NuxtLink></li>
          <li class="h4 md:mr-2 md:inline lg:block"><NuxtLink to="/stories"> STORIES</NuxtLink></li>
          <li class="h4 md:mr-2 md:inline lg:block"><NuxtLink to="/features"> FEATURES</NuxtLink></li>
          <!-- <li class="h4 md:mr-2 md:inline lg:!mb-0 lg:block"><NuxtLink to=""> PRICING</NuxtLink></li> -->
        </ul>
      </nav>
    </div>
    <div class="md:flex md:flex-col md:items-end md:justify-between">
      <button class="group mx-auto mb-8 flex items-baseline text-center invert hover:underline md:mr-0">
        GET AN INVITE <img class="ml-4 inline duration-300 ease-out group-hover:ml-6" src="/images/shared/desktop/arrow.svg" alt="" />
      </button>

      <p class="text-center text-light-gray opacity-50 md:!mb-0">Copyright 2019. All Rights Reserved</p>
    </div>
  </footer>
</template>
