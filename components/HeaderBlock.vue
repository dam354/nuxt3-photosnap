<template>
  <div>
    <div class="fixed top-0 left-0 right-0 z-10 bg-gray-100/90">
      <nav class="container mx-auto px-6 py-7 md:flex md:items-center md:justify-between">
        <div class="flex items-center justify-between">
          <NuxtLink to="/">
            <svg xmlns="http://www.w3.org/2000/svg" class="" width="170" height="16">
              <defs>
          ...
          <div @click="showMenu = !showMenu" class="flex md:hidden">
            <NavIcon :active="showMenu" />
          </div>
        </div>

        <!-- Mobile Menu open: "block", Menu closed: "hidden" -->
        <ul :class="showMenu ? 'flex' : 'hidden'" class="mt-8 flex-col space-y-4 md:mt-0 md:flex md:flex-row md:items-center md:space-y-0 md:space-x-10">
          <NuxtLink to="/"> <li class="hover:text-blue-400 text-sm font-bold text-gray-800">Home</li></NuxtLink>
          <NuxtLink to="/stories"> <li class="hover:text-blue-400 text-sm font-bold text-gray-800">Stories</li></NuxtLink>
          <NuxtLink to="/features"> <li class="hover:text-blue-400 text-sm font-bold text-gray-800">Features</li></NuxtLink>
        </ul>
      </nav>
    </div>
  </div>
